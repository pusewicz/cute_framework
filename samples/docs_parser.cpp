...
int main(int argc, char* argv[])
{
	...
	printf("Setting write directory to %s\n", path.c_str());
	...
	// Generate index.md file for each category
	{
		for (int i = 0; i < s->categories.count(); ++i) {
			const char* category = s->categories.items()[i];

			// Create the index.md path
			CF_Path index_path = get_relative_path();
			index_path.add(category);
			index_path.add("index.md");
			printf("Generating category index: %s\n", index_path.c_str());

			// Create the category directory if it doesn't exist
			CF_Path dir_path = index_path;
			dir_path.pop();
			std::filesystem::create_directory(dir_path.c_str());
			...
			if (fp) {
				fprintf(fp, "---\n");
				fprintf(fp, "title: %s\n", category);
				fprintf(fp, "parent: API Reference\n");
				fprintf(fp, "---\n");
				fprintf(fp, "[//]: # (This file is automatically generated by Cute Framework's docs parser.)\n");
				fprintf(fp, "[//]: # (Do not edit this file by hand!)\n");
				fprintf(fp, "[//]: # (See: https://github.com/RandyGaul/cute_framework/blob/master/samples/docs_parser.cpp)\n");
	...
	// Generate api_reference.md file.
	{
		...
		fprintf(fp, "---\n");
		fprintf(fp, "title: API Reference\n");
		fprintf(fp, "nav_order: 99\n");
		fprintf(fp, "---\n");
		fprintf(fp, "[//]: # (This file is automatically generated by Cute Framework's docs parser.)\n");
		fprintf(fp, "[//]: # (Do not edit this file by hand!)\n");
		fprintf(fp, "[//]: # (See: https://github.com/RandyGaul/cute_framework/blob/master/samples/docs_parser.cpp)\n");
		...
		related.add("allocator", {
			"- [Allocator](/docs/topics/allocator)",
		});
		related.add("app", {
			"- [Application Window](/docs/topics/application_window)",
			"- [Game Loop and Time](/docs/topics/game_loop_and_time)",
		});
		related.add("array", {
			"- [Data Structures](/docs/topics/data_structures)",
		});
		related.add("atomics", {
			"- [Atomics](/docs/topics/atomics)",
		});
		related.add("base64", {
			"- [Serialization](/docs/topics/serialization)",
		});
		related.add("collision", {
			"- [Collision](/docs/topics/collision)",
		});
		related.add("coroutine", {
			"- [Coroutines](/docs/topics/coroutines)",
		});
		related.add("draw", {
			"- [Drawing](/docs/topics/drawing)",
		});
		related.add("ecs", {
			"- [Entity Component System](/docs/topics/entity_component_system)",
		});
		related.add("file", {
			"- [Virtual File System](/docs/topics/virtual_file_system)",
		});
		related.add("graphics", {
			"- [Low Level Graphics](/docs/topics/low_level_graphics)",
		});
		related.add("haptic", {
			"- [Input](/docs/topics/input)",
		});
		related.add("hash", {
			"- [Data Structures](/docs/topics/data_structures)",
		});
		...
		related.add("multithreading", {
			"- [Atomics](/docs/topics/atomics)",
			"- [Multithreading](/docs/topics/multithreading)",
		});
		related.add("net", {
			"- [Networking](/docs/topics/networking)",
		});
		related.add("path", {
			"- [Virtual File System](/docs/topics/virtual_file_system)",
		});
		related.add("pathfinding", {
			"- [Path Finding](/docs/topics/pathfinding)",
		});
		related.add("random", {
			"- [Random Numbers](/docs/topics/random_numbers)",
		});
