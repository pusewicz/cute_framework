...
cache | Can be `NULL`. An optional cache to a previous call of this function. See [CF_GjkCache](/collision/cf_gjkcache) for details.
...
The GJK function is sensitive to large shapes, since it internally will compute signed area values. [cf_gjk](/collision/cf_gjk) is called throughout
