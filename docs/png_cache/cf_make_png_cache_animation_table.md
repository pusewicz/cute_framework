---
title: cf_make_png_cache_animation_table
parent: png_cache
---
...
Returns a [CF_Animation](/sprite/cf_animation) hashtable, see [htbl](/hash/htbl).

## Remarks

The table returned is a map of animation names to individual [CF_Animation](/sprite/cf_animation)'s. This is represents the guts of a sprite
