---
title: cf_make_sprite_from_memory
parent: sprite
---
...
Returns a [CF_Sprite](/sprite/cf_sprite) that can be drawn with `cf_sprite_draw`.
...
animation data, instead of using the .ase/.aseprite format, you can try out [cf_png_cache_load](/png_cache/cf_png_cache_load) for a more low-level option.
