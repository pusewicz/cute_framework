---
title: cf_make_easy_sprite_from_png
parent: sprite
---
...
Returns a [CF_Sprite](/sprite/cf_sprite) that can be drawn with `cf_sprite_draw`. The sprite is not animated,
as it's only a single-frame made from a png file.

## Remarks

The preferred way to make a sprite is [cf_make_sprite](/sprite/cf_make_sprite), but this function provides a very simple way to get started
