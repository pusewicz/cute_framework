---
title: cf_material_clear_uniforms
parent: graphics
---
...
Clears any uniforms previously set by [cf_material_set_uniform_vs](/graphics/cf_material_set_uniform_vs.md) or [cf_material_set_uniform_fs](/graphics/cf_material_set_uniform_fs.md).
