...
`CF_ShaderUniformMemberInfo* uniform_members` | Members of all uniform blocks tightly packed (see [CF_ShaderUniformInfo](/graphics/cf_shaderuniforminfo) for more details).
