...
Parameters for the function [cf_play_sound](/audio/cf_play_sound).
...
`int sample_index` | Default: 0. Specify the sample to start playing at. In term of seconds this would be the [cf_audio_sample_rate](/audio/cf_audio_sample_rate)  seconds.

## Remarks

You can use default settings from the [cf_sound_params_defaults](/audio/cf_sound_params_defaults) function.
