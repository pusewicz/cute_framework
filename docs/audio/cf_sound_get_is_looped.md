...
You can set a sound to looped with [cf_sound_set_is_looped](/audio/cf_sound_set_is_looped), or upon creation with [cf_play_sound](/audio/cf_play_sound).
