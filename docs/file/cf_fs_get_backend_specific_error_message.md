---
title: cf_fs_get_backend_specific_error_message
parent: file
---
...
on what might have happened. Often times this string is already returned to you inside a [CF_Result](/utility/cf_result).
