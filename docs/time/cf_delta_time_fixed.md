...
To turn on fixed-timestep use [cf_set_fixed_timestep](/time/cf_set_fixed_timestep). Fixed timestep is useful when games need determinism. Determinism
