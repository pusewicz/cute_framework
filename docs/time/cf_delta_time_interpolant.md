---
title: CF_DELTA_TIME_INTERPOLANT
parent: time
---
...
When fixed-timestepping is used (turned on by [cf_set_fixed_timestep](/time/cf_set_fixed_timestep)) usually rendering happens at a different frequency
