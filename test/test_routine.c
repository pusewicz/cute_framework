...
/* Test: basic state machine with integer labels */
TEST_CASE(test_routine_integer_labels_c) {
...
TEST_CASE(test_routine_seconds_c) {
	CF_Routine rt;
	cf_routine_init(&rt);
	float dt = 0.5f;
	int count = 0;
...
/* Test: nav_restart */
TEST_CASE(test_routine_restart_c) {
	CF_Routine rt;
	cf_routine_init(&rt);
	float dt = 0.016f;
	int start_count = 0;
...
TEST_SUITE(test_routine_c) {
	RUN_TEST_CASE(test_routine_init_c);
	RUN_TEST_CASE(test_routine_integer_labels_c);
	RUN_TEST_CASE(test_routine_once_c);
	RUN_TEST_CASE(test_routine_seconds_c);
	RUN_TEST_CASE(test_routine_restart_c);
	RUN_TEST_CASE(test_routine_redo_c);
}
