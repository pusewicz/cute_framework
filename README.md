...
1. Download and install CMake (4.2 or higher -- CF's own `cmake_minimum_required` -- you can just get the latest version). CMake is for easy cross-platform building. Also install [git](https://git-scm.com/downloads). If you're new to git and a Windows user it's highly recommended to use [GitHub Desktop](https://desktop.github.com/).
